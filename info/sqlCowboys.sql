...
# Dumping data for table duels_v201.buyitemsstore: ~13 rows (approximately)
...
INSERT INTO `transactions` (`id`, `authen`, `value`, `description`, `date`, `opponent_authen`) VALUES
	(3997, 'A:de76bac288', 10, 'Daily money', '1313537114', ''),
	(4004, 'A:de76bac288', 10, 'Duel', '1351439523', 'A:67851e4c55'),
	(4033, 'A:de76bac288', 50, 'Duel', '1351438523', 'A:67851e4c55'),
	(4123, 'A:de76bac288', 100, 'Daily money', '	1351427480', ''),
	(4979, 'A:de76bac288', 20, 'Daily money', '1351168280', ''),
	(129380, 'A:de76bac288', 22, 'Duel', '1351409523', 'F:100003796341366');
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `access_token` varchar(130) COLLATE utf8_bin NOT NULL,
  PRIMARY KEY (`user_id`),
...
INSERT INTO `users` (`user_id`, `authen`, `nickname`, `device_name`, `snetwork`, `last_login`, `first_login`, `type`, `region`, `current_language`, `os`, `app_ver`, `device_token`, `date`, `money`, `session_id`, `level`, `points`, `duels_win`, `duels_lost`, `bigest_win`, `remove_ads`, `avatar`, `age`, `home_town`, `friends`, `identifier`, `access_token`) VALUES
